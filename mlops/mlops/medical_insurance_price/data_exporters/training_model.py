...
from mlops.mi_util.models.sklearn import load_class, train_model, train_model_with_logging
...
def train(
    ...
    **kwargs,
    ...
    model,metrics = train_model_with_logging(model_class,hyperparameters,X_train,y_train,X_val,y_val,dv)
